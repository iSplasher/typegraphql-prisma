...
exports.toUnixPath = exports.cleanDocsString = exports.getInputTypeName = exports.getModelNameFromInputType = exports.pascalCase = exports.camelCase = exports.mapScalarToTypeGraphQLType = exports.getTypeGraphQLType = exports.mapScalarToTSType = exports.getFieldTSType = exports.noop = void 0;
...
function getTypeGraphQLType(typeInfo, dmmfDocument, modelName, typeName) {
    let GraphQLType;
    if (typeInfo.location === "scalar") {
