...
async function generateCode(dmmf, options, log = helpers_1.noop) {
    ...
    dmmfDocument.datamodel.models.forEach(model => model_type_class_1.default(project, baseDirPath, model, dmmfDocument));
    ...
    generate_enhance_1.generateEnhanceMap(enhanceSourceFile, dmmfDocument.modelMappings, dmmfDocument.relationModels, dmmfDocument.datamodel.models, dmmfDocument.schema.inputTypes, dmmfDocument.schema.outputTypes);
