    ...
    return (outputType) => {
        ...
        return {
            ...
            fields: outputType.fields.map(field => {
                ...
                const fieldTSType = helpers_2.getFieldTSType(dmmfDocument, outputType, isFieldRequired, false);
                const typeGraphQLType = helpers_2.getTypeGraphQLType(outputType, dmmfDocument);
