...
function generateEnhanceMap(sourceFile, modelMappings, relationModels, models, inputs, outputs) {
    ...
    sourceFile.addVariableStatement({
        ...
        declarations: [
            {
                name: "modelsInfo",
                initializer: ts_morph_1.Writers.object(Object.fromEntries(models.map(model => {
